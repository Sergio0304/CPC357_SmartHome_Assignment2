...
## 📌 Project Overview
This project presents a **Smart Home IoT System** designed and implemented as part of **CPC357: IoT Architecture & Smart Applications**. The system integrates **edge devices**, **cloud computing**, and **real-time data visualization** to address smart city challenges, contributing to the **United Nations Sustainable Development Goal (SDG) 11 – Sustainable Cities and Communities**.
...
- Integrate cloud computing using Google Cloud Platform (GCP)  
...
|----------|------------|
| **Perception Layer** | Sensors and actuators such as NFC, PIR, Ultrasonic, Rain sensor, DHT11/DHT22, INMP441 microphone, servos, and relays |
...
## 🧪 Development Process
1. Cloud setup on GCP VM (MQTT + Node-RED)  
2. Firmware development for Arduino UNO R4 WiFi (Smart Door)  
3. Firmware development for ESP32-S3 (AI Window & Drying Rack)  
4. Dataset collection and training using Edge Impulse  
5. MQTT integration between edge devices and cloud  
6. Node-RED automation and dashboard design  
7. System integration and end-to-end testing  
...
**Process:**
1. Audio samples recorded using INMP441 microphone  
2. Dataset uploaded to Edge Impulse  
3. Feature extraction using MFCC  
4. Model trained and validated  
5. Arduino inference library generated and deployed  
